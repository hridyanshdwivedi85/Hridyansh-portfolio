(() => {
  ...
  function drawCloud(cloud) {
    ...
    ctx.lineWidth = 2;
    ctx.strokeRect(cloud.x + 8, cloud.y + 2, 8, 5);
    ctx.strokeRect(cloud.x + 16, cloud.y, 10, 7);
    ctx.strokeRect(cloud.x + 24, cloud.y + 2, 8, 5);
  }
  ...
  function drawDino() {
    ...
    if (ducking) {
      ctx.strokeRect(x + 2, baseY - 22, 30, 16);
      ctx.strokeRect(x + 30, baseY - 20, 9, 10);
      ctx.strokeRect(x + (dino.legFrame ? 9 : 18), baseY - 6, 8, 6);
      return;
    }

    ctx.strokeRect(x + 8, baseY - 42, 18, 22); // body
    ctx.strokeRect(x + 22, baseY - 52, 12, 14); // neck/head
    ctx.strokeRect(x + 30, baseY - 50, 9, 10);
    ctx.fillStyle = '#535353';
    if (!state.gameOver || Math.floor(state.blinkTick / 120) % 2 === 0) {
      ctx.fillRect(x + 33, baseY - 47, 2, 2); // eye
    }
    ctx.strokeRect(x + 10 + (dino.legFrame ? 0 : 8), baseY - 18, 6, 18);
    ctx.strokeRect(x + 10 + (dino.legFrame ? 8 : 0), baseY - 18, 6, 18);
    ctx.strokeRect(x + 5, baseY - 28, 6, 12); // tail
  }
  ...
  function drawCactus(o) {
    ...
    ctx.strokeRect(o.x - 5, o.y + 8, 6, 10);
    ctx.strokeRect(o.x + o.w - 1, o.y + 14, 6, 10);
  }

  function drawBird(o) {
    ctx.strokeStyle = '#535353';
    ctx.lineWidth = 2;
    ctx.strokeRect(o.x + 7, o.y + 8, 18, 8);
    ctx.strokeRect(o.x + 22, o.y + 6, 6, 6);
    if (o.frame) {
      ctx.strokeRect(o.x + 1, o.y + 1, 10, 6);
      ctx.strokeRect(o.x + 11, o.y + 1, 8, 4);
    } else {
      ctx.strokeRect(o.x + 1, o.y + 12, 10, 6);
      ctx.strokeRect(o.x + 11, o.y + 14, 8, 4);
    }
  }
  ...
  function drawGround() {
    ...
    for (let i = -1; i < 20; i += 1) {
      const x = i * 34 - shift;
      ctx.strokeRect(x + 8, GROUND_Y + 4, 4, 2);
      ctx.strokeRect(x + 20, GROUND_Y + 7, 3, 2);
    }
  }
